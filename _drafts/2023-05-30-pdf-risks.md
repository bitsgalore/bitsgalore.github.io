...
JHOVE again only reports the confusing "Compression method is invalid or unknown to JHOVE" error (example [here](https://github.com/KBNLresearch/pdf-characterisation/blob/main/output/horror/encryption_noprinting-jhove.xml)), and doesn't even do any further parsing.
