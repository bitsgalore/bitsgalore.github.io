...
This message is not particularly informative or helpful, and this [has been a known bug](https://github.com/openpreserve/jhove/issues/640) for over two years.
...
|:--|:--|:--|:--|
|AdobeChassisDemo-commented_Review.pdf|JavaScript|Text<br>3D<br>Polygon<br>Ink<br>Popup|Popup<br>Text<br>Polygon<br>Ink<br>3D|
|[movie.pdf](https://web.archive.org/web/20100714002808/http://acroeng.adobe.com:80/Test_Files/movie/movie.pdf)||Movie||
|MusicalScore.pdf|GoTo<br>URI<br>Rendition<br>JavaScript|Screen<br>Link<br>Widget|Screen<br>Widget<br>Link|
|LabelExample.pdf|GoTo3DView<br>JavaScript|Widget<br>3D|Widget<br>3D|
|MultiMedia_Acro6.pdf|Rendition|Screen|Screen|
|AVI+Transitions Demo.pdf||||
|[20020402_CALOS.pdf](https://web.archive.org/web/20140519130059/http://acroeng.adobe.com/Test_Files/classic_multimedia//20020402_CALOS.pdf)|GoTo<br>Named<br>Hide<br>Movie|Movie<br>Link<br>Widget||
|Disney-Flash.pdf|SubmitForm<br>URI<br>Rendition|Widget<br>Link<br>Screen|Screen<br>Widget<br>Link|
|gXsummer2004-stream.pdf||||
|SVG-AnnotAnim.pdf||SVG||
|Service Form_media.pdf|ResetForm<br>JavaScript<br>SubmitForm<br>Named<br>Rendition|Screen<br>Link<br>Widget|Widget<br>Screen<br>Link|
|Binder_6-3DPages.pdf|GoTo|3D|3D|
|us_population.pdf|GoTo|SVG|SVG|
|SVG.pdf|URI<br>JavaScript|Widget|Widget|
|phlmapbeta7.pdf|Rendition|Screen|Screen|
|ScriptEvents.pdf|GoTo<br>Rendition<br>JavaScript|Widget<br>Screen|Screen<br>Widget|
|Trophy.pdf|Rendition<br>JavaScript<br>URI<br>GoTo|Screen<br>Widget<br>Link|Screen<br>Widget<br>Link|
|VolvoS40V50-Full.pdf|Named<br>URI<br>Rendition<br>GoTo<br>JavaScript|Widget<br>Screen<br>Link|Screen<br>Link<br>Widget|
|Jpeg_linked.pdf|Rendition<br>Named<br>GoTo|Link<br>Screen|Link<br>Screen|
...
- JHOVE's reporting on **encryption and security-related restrictions** is not very informative, and also confusing.
- Even though JHOVE does report whether **fonts are embedded**, this information is encoded in a way that is needlessly complicated (and undocumented).
- **No documentation exists of any of JHOVE's reported properties**. This can make their interpretation difficult. The font embedding issue is a good example of this: if we want to know if a particular font is embedded or not, we need to check three separate properties (*FontFile*, *FontFile2* and *FontFile3*), which are all undocumented. I was only able to figure this out by digging into JHOVE's source code, and consulting the ISO 32000-1 PDF specification.
...
- Finally, the tests showed that JHOVE tends to **"give up" parsing** rather more quickly compared against VeraPDF, and when this happens it will not give any meaningful information about the file at all. Examples are PDFs with security-related restrictions (e.g. copy, printing and text access passwords), but also PDF 2.0 documents.
