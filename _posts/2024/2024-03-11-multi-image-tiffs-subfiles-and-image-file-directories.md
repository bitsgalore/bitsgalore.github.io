...
<figure class="image">
  <img src="{{ BASE_PATH }}/images/2024/03/confused-muddled-illogical-957696-1024.jpg" alt="Photograph that shows a hammer that is used to smash a screw into a piece of wood. On the left is a nail that is partially pushed into the same piece of wood, with an adjustable wrench immediately next to it.">
